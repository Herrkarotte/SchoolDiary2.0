...
interface ScheduleRepository {
    ...
    suspend fun updateHomeWork(homework: UpdateHomework)
}
...
class ScheduleRepositoryImp @Inject constructor(
    ...
    override suspend fun getScheduleForStudent(weekId: String): ScheduleResponseItem {
    ...
    override suspend fun updateHomeWork(homework: UpdateHomework) {
        return api.updateHomework(homework)
    }
}
